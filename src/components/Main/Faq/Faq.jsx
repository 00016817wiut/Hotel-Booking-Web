...
const faqItems = [
  ...
  {
    question: "Можно ли забронировать номер заранее?",
    answer:
      "Да, конечно. Вы можете связаться с нами через Telegram, Instagram или по телефону и забронировать номер заранее.",
  },
  {
